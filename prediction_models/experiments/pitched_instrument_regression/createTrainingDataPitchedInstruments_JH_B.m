...
function createTrainingDataPitchedInstruments_JH_B(write_file_name, quick)
DATA_PATH = '../../../../dataset/';
...
% Scanning Options.
FBA_RELATIVE_PATH = '../../../../dataset/2015-2016';%FBA2013';¡¾¡¿¡¾¡¿¡¾¡¿¡¾¡¿¡¾¡¿¡¾¡¿¡¾¡¿
BAND_OPTION = 'middle';
...
audition_metadata = scanFBA(FBA_RELATIVE_PATH, ...
                            ...
                            SEGMENT_OPTION, SCORE_OPTION, '2015');%¡¾¡¿¡¾¡¿¡¾¡¿2015
...
for(student_idx = 1:num_students)
  ...
  features(student_idx, :) = ...
      extractStdFeatures(normalized_audio, Fs, HOP_SIZE);
