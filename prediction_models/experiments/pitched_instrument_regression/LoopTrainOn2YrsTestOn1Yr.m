...
write_file_name = ['middleAlto Saxophone5_Score_2013'];%['Score_middleAltoSaxophone_segment2_pitchCrctd_featCrctd_201' num2str(yr1)];
...
write_file_name = ['middleAlto Saxophone5_Score_2014'];%['Score_middleAltoSaxophone_segment2_pitchCrctd_featCrctd_201' num2str(yr2)];
load([full_data_path write_file_name]);
% features(:,14)=features(:,14)./features(:,23);
% features(:,delFeat)=[];
...
write_file_name = ['middleAlto Saxophone5_Score_2015'];%['Score_middleAltoSaxophone_segment2_pitchCrctd_featCrctd_201' num2str(yr3)];
root_path = deriveRootPath();
full_data_path = [root_path DATA_PATH];
load([full_data_path write_file_name]);
% features(:,14)=features(:,14)./features(:,23);
